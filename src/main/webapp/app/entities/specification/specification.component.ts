...
currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.specificationService.search({
    ...
    trackId(index: number, item: Specification) {
        return item.id;
    }
    registerChangeInSpecifications() {
        this.eventSubscriber = this.eventManager.subscribe('specificationListModification', (response) => this.loadAll());
    }
